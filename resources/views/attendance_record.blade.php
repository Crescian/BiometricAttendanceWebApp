<x-app-layout>
    ...
    <div class="px-16 py-5">
        ...
        {{-- <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Pending -->
            <div onclick="loadAttendanceRecord('Pending');"
            ...
            <!-- Approved -->
            <div onclick="loadAttendanceRecord('Approved');"
            ...
            <!-- Cancelled -->
            <div onclick="loadAttendanceRecord('Cancelled');"
    ...
    <script>
        ...
        function loadAttendanceRecordCounts() {
            $.ajax({
                url: "{{ route('department.getUserDepartment') }}",
                type: 'GET',
                dataType: 'json',
